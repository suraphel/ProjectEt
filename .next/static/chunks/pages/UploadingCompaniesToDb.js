      ...
      return A_Projects_NextJs_Balemoja_Next_Balemoja_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("https://test-2a962-default-rtdb.europe-west1.firebasedatabase.app/Companies.json", // "https://balemoja-9c5e6-default-rtdb.europe-west1.firebasedatabase.app/Companies.json",
              {
                method: "POST",
